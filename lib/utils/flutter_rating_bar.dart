...
class RatingBarIndicator extends StatefulWidget {
  ...
  /// { flutterRatingBar.itemCount}
  final int itemCount;

  /// { flutterRatingBar.itemSize}
  final double itemSize;

  /// { flutterRatingBar.itemPadding}
  ...
  /// { flutterRatingBar.textDirection}
  final TextDirection? textDirection;

  /// { flutterRatingBar.itemBuilder}
  final IndexedWidgetBuilder itemBuilder;

  /// { flutterRatingBar.direction}
  final Axis direction;

  /// { flutterRatingBar.unratedColor}
  final Color? unratedColor;
